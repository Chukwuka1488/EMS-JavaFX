...
public class AutoEmployeeController implements Initializable {
    ...
    public void LoadEmployeesData() {
        try {
            ...
            String query = "SELECT * FROM employees_acc WHERE Kompetenzen LIKE '%Auto%' OR Kompetenzen LIKE '%BMW%' " +
                    "OR Kompetenzen LIKE '%Motor%' OR Kompetenzen LIKE '%AUTO%' OR Kompetenzen LIKE '%Daim%'   ";
            assert conn != null;
