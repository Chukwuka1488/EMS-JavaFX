...
public class AeroEmployeeController implements Initializable {
    ...
    public void LoadEmployeesData() {
        try {
            ...
            String query = "SELECT * FROM employees_acc WHERE Kompetenzen LIKE '%Air%' OR Kompetenzen LIKE '%Luft%'" +
                    "OR Kompetenzen LIKE '%Flug%'";
            assert conn != null;
